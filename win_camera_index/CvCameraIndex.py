...
# 加载对应位数动态链接库
_CvCameraIndex = ctypes.cdll.LoadLibrary('win_camera_index/lib/CvCameraIndex_x64.dll')
...
if __name__ == '__main__':
    camera_index = get_camera_index('vid_2B89&pid_3236')
    print(camera_index)


# 利用这个python文件对获取到的所有 pid vid进行扫描